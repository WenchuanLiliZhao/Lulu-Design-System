...
const Group1: PageShape[] = [
  ...
  },
  {
    info: {
      ...
      type: "report",
      date: new Date("2025-03-15 14:00:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "dataset",
      date: new Date("2025-02-20 09:30:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "dashboard",
      date: new Date("2025-01-10 11:45:00"),
    },
  ...
  },
  {
    info: {
      slug: "blog",
      title: "Blog Resource",
      title_display: "Our Blog",
      type: "report",
      date: new Date("2025-04-01 08:15:00"),
    },
    content: <div>Read our latest blog posts.</div>,
  },
];

const Group2: PageShape[] = [
  {
    info: {
      slug: "faq",
      ...
      type: "report",
      date: new Date("2025-03-05 10:20:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "dashboard",
      date: new Date("2025-02-25 16:00:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "key",
      date: new Date("2025-01-30 12:00:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "chart",
      date: new Date("2025-03-10 14:30:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "report",
      date: new Date("2025-04-05 09:00:00"),
    },
    content: <div>Read testimonials from our clients.</div>,
  },
];

const Group3: PageShape[] = [
  {
    info: {
      slug: "pricing",
      ...
      type: "report",
      date: new Date("2025-02-15 11:00:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "chart",
      date: new Date("2025-03-20 13:15:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "dashboard",
      date: new Date("2025-04-10 15:45:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "report",
      date: new Date("2025-01-05 10:10:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "dataset",
      date: new Date("2025-03-25 09:50:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "key",
      date: new Date("2025-02-10 14:40:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "dashboard",
      date: new Date("2025-04-20 16:30:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "report",
      date: new Date("2025-01-25 12:20:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "report",
      date: new Date("2025-03-01 10:05:00"),
    },
  ...
  },
  {
    info: {
      ...
      type: "dashboard",
      date: new Date("2025-04-15 08:00:00"),
    },
